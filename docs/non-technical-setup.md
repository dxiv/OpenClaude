...
Shortest path: **npm install**, set a few **environment variables**, run **`dxa-agent`**. No source build, no Bun, no need to read the codebase—only a terminal and Node.js 20+.
